...
public final class  TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 465.87768974491536; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2578.703075815037; // x position of the perpendicular encoder (in tick units)
    }
